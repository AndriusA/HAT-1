...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.start_time'
        raise RuntimeError("Cannot reverse this migration. 'Event.start_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Event.start_time'
    ...
    models = {
        ...
        u'things.sensor': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sensor_id': ('django.db.models.fields.CharField', [], {'default': "'bd9ded8c-b054-4694-bb7d-66434026369d'", 'max_length': '36'})
        },
        u'things.sensordata': {
