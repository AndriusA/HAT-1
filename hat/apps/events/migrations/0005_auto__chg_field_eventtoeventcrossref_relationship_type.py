...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventToEventCrossRef.relationship_type'
        db.alter_column(u'events_eventtoeventcrossref', 'relationship_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventToEventRelationshipType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EventToEventCrossRef.relationship_type'
        raise RuntimeError("Cannot reverse this migration. 'EventToEventCrossRef.relationship_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EventToEventCrossRef.relationship_type'
        db.alter_column(u'events_eventtoeventcrossref', 'relationship_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventToEventRelationshipType']))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 9, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 9, 0, 0)'}),
        ...
        u'things.sensor': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sensor_id': ('django.db.models.fields.CharField', [], {'default': "'fcbbe20b-afb6-421c-afe3-c78aeeba8ba3'", 'max_length': '36'})
        },
        u'things.sensordata': {
